...
# Database URL should be set in environment variables, not hardcoded
# This is just a placeholder - set the real value in DigitalOcean
...
RUN chmod +x ./scripts/init-db.sh ./scripts/start.sh
